...
router.post('/analyze', async (req: Request, res: Response) => {
  const { repoUrl, generatePatches = true }: AnalyzeRequest = req.body;
...
async function runAnalysis(sessionId: string, repoUrl: string, generatePatches: boolean) {
 ...
 */
router.get('/analyze/:sessionId', (req: Request, res: Response) => {
...
router.post('/analyze-quick', async (req: Request, res: Response) => {
  const { repoUrl, generatePatches = false }: AnalyzeRequest = req.body;
