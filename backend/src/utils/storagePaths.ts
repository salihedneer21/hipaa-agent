...
export function getSessionRepoDir(sessionId: string): string {
...
export function getSessionResultPath(sessionId: string): string {
  return path.join(getSessionDir(sessionId), 'result.json');
}

export function getSessionAnalysisPath(sessionId: string): string {
  return path.join(getSessionDir(sessionId), 'analysis.json');
}

export function getSessionPatchesPath(sessionId: string): string {
  return path.join(getSessionDir(sessionId), 'patches.json');
}

export function getSessionDiagramsDir(sessionId: string): string {
...
export function getClientGitHubDir(clientId: string): string {
  return path.join(GITHUB_DIR, 'clients', clientId);
}

export function getClientGitHubInstallationsPath(clientId: string): string {
